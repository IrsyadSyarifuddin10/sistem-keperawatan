        ...
        <div class="max-w-7xl xl:max-w-[1920px] mx-auto px-2 sm:px-2 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg pt-6 px-6 ">
                <div class="p-3 text-gray-900 block w-full overflow-x-auto">
                    ...
                    <table id="tbInputLogbookPKUGD" class="items-center bg-transparent w-full">
                        ...
                        <tbody>
                            <form action="{{ route('input-logbook-pk-ugd') }}" method="POST">
                                ...
                                <tr>
                                    <!-- Kolom Pertama: Nama logbook-pk-ugd -->
                                    <td
                    ...
                    <div class="flex flex-row pt-4 px-6">
                        <x-input-label for="catatan-logbook-pk-ugd" :value="__('Catatan')" />
                        <textarea name="catatan-logbook-pk-ugd" class="form-control mx-2 w-full" rows="3"></textarea>
                    </div>
                    <div class="flex flex-row pt-12 justify-end">
                        ...
                        <button id="btnSimpanLogbookPKUGD" type="button"
