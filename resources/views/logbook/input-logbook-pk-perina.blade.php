...
$v_logbook_pk_perina_formatted = array_map(function ($item) {
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg pt-6 px-6 ">
                <div class="p-3 text-gray-900 block w-full overflow-x-auto">
                    <div class="p-3 text-2xl font-black">
                        Input Logbook PK Perina
                    </div>
                    <table id="tbInputLogbookPKPerina" class="items-center bg-transparent w-full">
                        ...
                        <tbody>
                            <form action="{{ route('input-logbook-pk-perina') }}" method="POST">
                                <?php foreach ($v_logbook_pk_perina_formatted as $index => $item): ?>
                                <?php    $fitem = $f_logbook_pk_perina[$index] ?? null; ?>
                                <tr>
                                    <!-- Kolom Pertama: Nama logbook-pk-perina -->
                                    <td
                    ...
                    <div class="flex flex-row pt-4 px-6">
                        <x-input-label for="catatan-logbook-pk-perina" :value="__('Catatan')" />
                        <textarea name="catatan-logbook-pk-perina" class="form-control mx-2 w-full" rows="3"></textarea>
                    </div>
                    <div class="flex flex-row pt-12 justify-end">
                        ...
                        <button id="btnSimpanLogbookPKPerina" type="button"
